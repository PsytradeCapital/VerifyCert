...
export const LazyImageWithPlaceholder: React.FC<LazyImageWithPlaceholderProps> = ({
  ...
  return (
    <LazyImage
      src={src}
      alt={alt}
      className={`${className} ${aspectClasses[aspectRatio]} object-cover`}
      loadingComponent={() => (
        <div className={`bg-gray-200 animate-pulse ${className} ${aspectClasses[aspectRatio]} flex items-center justify-center`}>
      ...
      errorComponent={({ retry }) => (
        <div className={`bg-gray-100 border-2 border-dashed border-gray-300 ${className} ${aspectClasses[aspectRatio]} flex flex-col items-center justify-center p-4`}>
